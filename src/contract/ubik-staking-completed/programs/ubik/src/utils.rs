...
//## Are not we using regular transfer of the token that works with solana built-in methods?
#[inline(always)] //## Why do we need to use inline(always) macro here?
pub fn spl_token_transfer_without_seed(params: TokenTransferParamsWithoutSeed<'_>) -> Result<()> {
...
//## Are not we using regular transfer of the token that works with solana built-in methods?
#[inline(always)]
pub fn spl_token_set_authority(params : TokenSetAuthorityParams<'_>) -> Result<()> {
